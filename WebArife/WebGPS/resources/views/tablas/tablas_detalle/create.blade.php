...
@section ('contenido')
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        {!! Form::open(array('url'=>'tablas/tablas_detalle','method'=>'POST','autocomplete'=>'off')) !!}
        {{Form::token()}}
        <div class="form-group">
          <label for="IdTablaDetalle">Id</label>
          <input type="text" name="IdTablaDetalle" required value="{{old('IdTablaDetalle')}}" class="form-control" placeholder="Id TablaDetalle">
        </div>
        <div class="form-group">
