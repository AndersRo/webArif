    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          ...
          <input type="text" name="PrimerNombre" class="form-control" placeholde="PrimerNombre">
        </div>
        <div class="form-group">
          <label for="SegundoNombre">Segundo Nombre</label>
          <input type="text" name="SegundoNombre" class="form-control" placeholder="SegundoNombre">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="FlgEli">Estado</label>
          <input type="text" name="FlgEli" class="form-control" placeholder="Estado">
        </div>
        <div class="form-group">
          <button class="btn btn-primary" type="submit" name="button">Guardar</button>
          <button class="btn btn-danger" type="reset" name="button">Eliminar</button>
        </div>
        {!!Form::close()!!}
      </div>
    </div>
