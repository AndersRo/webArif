...
@section ('contenido')
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        {!! Form::open(array('url'=>'plataforma/AccesoPlataforma','method'=>'POST','autocomplete'=>'off')) !!}
        {{Form::token()}}
        ...
        <div class="form-group">
          <label for="IdAcceso">Acesso comandos</label>
          <input type="text" name="IdAcceso" class="form-control" placeholder="IdAcceso">
       </div>
