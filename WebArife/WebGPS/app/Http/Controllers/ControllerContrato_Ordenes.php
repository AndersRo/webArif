...
use webGps\app\Contrato_Ordenes;
use Illuminate\Support\Facades\Redirect;
use webGps\Http\Request\Contrato_OrdenesFormRequest;
use DB;

class ControllerContrato_Ordenes extends Controller
{
...
public function index(Request $request){
  if ($request) {
    ...
    ->paginate(7);
    return view ('Contrato_Ordenes.index',["Contrato_Ordenes"=>$Contrato_Ordenes,"searchText"=>$query]);
  }
}
public function create(){
  return view("Contrato_Ordenes.create");
}
public function store(Contrato_OrdenesFormRequest $request){
  ...
  return Redirect::to('Contrato_Ordenes');
}
public function show($id){



  return view("Contrato_Ordenes.show", ["Contrato_Ordenes"=>Contrato_Ordenes::findOrFail($id)]);
}
public function edit($id){
  return view("Contrato_Ordenes.edit", ["Contrato_Ordenes"=>Contrato_Ordenes::findOrFail($id)]);
}
